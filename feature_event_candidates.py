...
REQUESTED_FEATURES=["l1_churn_notional_200ms","l1_churn_notional_500ms","l1_churn_notional_1000ms","l1_churn_over_depth_200ms","l1_churn_over_depth_500ms","bid_l1_cancel_to_add_ratio_200ms","ask_l1_cancel_to_add_ratio_200ms","bid_l1_cancel_to_add_ratio_500ms","ask_l1_cancel_to_add_ratio_500ms","same_side_replenishment_after_depletion_200ms","opposite_side_replenishment_after_depletion_200ms","buy_trade_depth_recovery_ratio_200ms","sell_trade_depth_recovery_ratio_200ms","buy_trade_depth_recovery_ratio_500ms","sell_trade_depth_recovery_ratio_500ms","trade_impact_decay_ratio_200_to_1000ms","trade_impact_half_life_proxy","event_interarrival_cv_200ms","event_interarrival_cv_500ms","event_interarrival_cv_1000ms","ob_interarrival_cv_500ms","trade_interarrival_cv_500ms","event_burstiness_ewma_fast_slow","trade_burstiness_ewma_fast_slow","ob_burstiness_ewma_fast_slow","max_event_gap_1000ms","min_event_gap_1000ms","aggressor_run_length_current","aggressor_run_length_max_1000ms","aggressor_run_length_mean_1000ms","trade_sign_entropy_1000ms","trade_sign_entropy_3000ms","trade_sign_flip_rate_1000ms","trade_sign_flip_rate_3000ms","same_side_trade_cluster_count_1000ms","trade_size_hhi_1000ms","trade_size_hhi_3000ms","largest_trade_share_notional_1000ms","largest_trade_share_notional_3000ms","top3_trade_share_notional_1000ms","trade_size_p90_over_median_3000ms","trade_size_max_over_ewma_3000ms","bid_depth_convexity_1_5_10bps","ask_depth_convexity_1_5_10bps","depth_slope_bid_1_to_10","depth_slope_ask_1_to_10","depth_slope_imbalance_1_to_10","thin_side_depth_gap_ratio","book_shape_asymmetry_convexity","bid_queue_cliff_ratio_l1_l2","ask_queue_cliff_ratio_l1_l2","bid_queue_cliff_ratio_l1_l5","ask_queue_cliff_ratio_l1_l5","near_touch_depth_drop_bid","near_touch_depth_drop_ask","near_touch_depth_drop_asymmetry","book_stability_score_1000ms","book_stability_score_3000ms","no_trade_no_book_change_age_ms","mid_unchanged_and_depth_stable_ms","quiet_liquid_state_score","quiet_thin_state_score","active_liquid_state_score","active_thin_state_score","microprice_realized_vol_500ms","microprice_realized_vol_1000ms","obi_realized_vol_500ms","obi_realized_vol_1000ms","spread_realized_vol_1000ms","obi_zero_cross_rate_1000ms","ofi_l1_over_effective_depth_200ms","ofi_l1_over_effective_depth_500ms","ofi_l5_over_effective_depth_500ms","ofi_pressure_x_thin_book_200ms","ofi_pressure_x_burstiness_500ms","abs_ofi_over_depth_1000ms","signed_ofi_over_depth_1000ms"]
...
class MovementMicrostructureCandidatePack:
    ...
    def emit(self):
        ...
        o["aggressor_run_length_current"]=self.cur_run; o["aggressor_run_length_max_1000ms"]=max(counts,default=0.0); o["aggressor_run_length_mean_1000ms"]=float(np.mean(counts)) if counts else 0.0; o["same_side_trade_cluster_count_1000ms"]=max(counts,default=0.0)
        ...
        o["top3_trade_share_notional_1000ms"]=self._topk_share(vals1,3)
        ...
        o["bid_depth_convexity_1_5_10bps"]=bid_conv; o["ask_depth_convexity_1_5_10bps"]=ask_conv; o["depth_slope_bid_1_to_10"]=bid_slope; o["depth_slope_ask_1_to_10"]=ask_slope; o["depth_slope_imbalance_1_to_10"]=(bid_slope-ask_slope)/max(abs(bid_slope)+abs(ask_slope),EPS); o["thin_side_depth_gap_ratio"]=thin_void/max(thick_void,EPS); o["book_shape_asymmetry_convexity"]=(bid_conv-ask_conv)/max(abs(bid_conv)+abs(ask_conv),EPS)
        ...
        o["ofi_l1_over_effective_depth_200ms"]=ofi200/total_depth_5; o["ofi_l1_over_effective_depth_500ms"]=ofi500/total_depth_5; o["ofi_l5_over_effective_depth_500ms"]=ofi5_500/total_depth_5; o["ofi_pressure_x_thin_book_200ms"]=abs(ofi200/total_depth_5)/max(math.log1p(total_depth_5),EPS); o["ofi_pressure_x_burstiness_500ms"]=abs(ofi500/total_depth_5)*o["event_burstiness_ewma_fast_slow"]; o["abs_ofi_over_depth_1000ms"]=abs(ofi1000)/total_depth_5; o["signed_ofi_over_depth_1000ms"]=ofi1000/total_depth_5
