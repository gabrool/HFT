...
# ---------------------------  Core hyper-params  ---------------------------
LOOKBACK        = 1024       # number of tokens spanning ~10s
...
HORIZON_WEIGHTS = [0.01, 0.02, 0.05, 0.1, 1.0]
...
class ConvEncoder(nn.Module):
    def __init__(self, d_model, d_ff, kernel_size=[3,5,7,11,13,17], dropout=0.1, activation='gelu', 
                 n_layers=4, enable_res_param=True, norm='batch', re_param=True, small_ks=3):
...
class SAMBA(nn.Module):
    def __init__(self, args: ModelArgs):
        ...
        self.depatch_proj_encoder = ConvTimeNetFeatureExtractor(
            ...
            dw_ks=[3,5,7,11,13,17], n_layers=4, d_ff=256, dropout=0.1, act='gelu', 
