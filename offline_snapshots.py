...
Snapshots are OB-only.
Each row is emitted at the repaired OB event timestamp.
There is no grid quantization and no 100ms fill-forward.
            ...
            for line_no, line in enumerate(f, start=1):
                ...
                if last_seen_ts_ms is not None and repaired_ts_ms < last_seen_ts_ms:
                    ...
                    if BYBIT_STRICT_DATA:
                        raise ValueError(
                            "Non-decreasing OB timestamps violated: "
