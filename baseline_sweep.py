...
def build_metadata(
    ...
    *,
    ...
    metadata = {
        ...
        "prepared_joined_rows": prepared_context.joined_rl_rows,
        "prepared_val_rows": int(prepared_context.mm_rl_val_batch.features.shape[0]),
        "prepared_test_rows": int(prepared_context.mm_rl_test_batch.features.shape[0]),
