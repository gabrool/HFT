...
CORR_PRUNED152_HEAD_SUBSET_V5 = "corr_pruned152_head_subset_v5"
...
MAGNITUDE_UP_CORR_PRUNED152_V5 = (
    "x_trade_count_per_second_1000000us",
    "x_bid_depth_notional_5bps",
    "x_trade_sign_entropy_3000000us",
    "x_log_events_1000000us",
...
MAGNITUDE_DOWN_CORR_PRUNED152_V5 = MAGNITUDE_DOWN_CORR_PRUNED152_V4

CORR_PRUNED152_HEAD_SUBSET_V5_COLUMNS_BY_HEAD = {
    lm.DIRECTION_HEAD: DIRECTION_CORR_PRUNED152_V5,
    lm.NO_MOVE_HEAD: NO_MOVE_CORR_PRUNED152_V5,
    lm.MAGNITUDE_UP_HEAD: MAGNITUDE_UP_CORR_PRUNED152_V5,
    lm.MAGNITUDE_DOWN_HEAD: MAGNITUDE_DOWN_CORR_PRUNED152_V5,
}
...
assert len(DIRECTION_CORR_PRUNED152_V5) == 20
assert len(NO_MOVE_CORR_PRUNED152_V5) == 35
assert len(MAGNITUDE_UP_CORR_PRUNED152_V5) == 13
assert len(MAGNITUDE_DOWN_CORR_PRUNED152_V5) == 6
...
for _cols in (
    ...
    NO_MOVE_CORR_PRUNED152_V5,
    MAGNITUDE_UP_CORR_PRUNED152_V5,
    MAGNITUDE_DOWN_CORR_PRUNED152_V5,
):
...
assert set(CORR_PRUNED152_HEAD_SUBSET_V5_COLUMNS_BY_HEAD) == set(lm.MODEL_HEADS)
...
def head_feature_config_for_preset(name: str) -> hf.HeadFeatureConfig:
    ...
    if preset == CORR_PRUNED152_HEAD_SUBSET_V5:
        return hf.HeadFeatureConfig(
            feature_columns_by_head=CORR_PRUNED152_HEAD_SUBSET_V5_COLUMNS_BY_HEAD
        )
