...
def _dataset(tmp_path, rows=6):
    meta={"exchange":"ex","symbol":"SYM","tape_schema":"schema","tape_num_events":1,"tape_num_l2_batches":1,"tape_num_trades":0,"tape_start_local_ts_us":1,"tape_end_local_ts_us":2,"decision_interval_us":1,"start_event_index":None,"max_decisions":None,"config_json":"{}"}
