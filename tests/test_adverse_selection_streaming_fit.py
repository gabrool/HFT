...
def _dataset(tmp_path, rows=6):
    meta={"exchange":"ex","symbol":"SYM","tape_schema":"schema","tape_num_events":1,"tape_num_l2_batches":1,"tape_num_trades":0,"tape_start_local_ts_us":1,"tape_end_local_ts_us":2,**grid_lineage_fields(n_rows=rows),"config_json":"{}","index_schema":"mmrt_adverse_selection_index_v2","index_manifest_sha256":"0"*64,"index_root":"/tmp/index"}
